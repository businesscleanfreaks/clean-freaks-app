  ...
  return (
    <section className="rounded-[10px] bg-white" style={{ border: "1px solid #FDE68A" }}>
      <div className="flex items-center justify-between px-5 pt-4 pb-2">
        ...
        <span className="rounded-full bg-amber-50 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-amber-700">Auto-applied</span>
      </div>
      <div className="px-5 pb-4">
        {rows.map((r) => <ProrationRowView key={r.locationId} row={r} />)}
        ...
        <p className="mt-2 text-[11px] text-zinc-400">
          Credit for cleans missed this month (e.g. a paused week), automatically applied to this month&apos;s invoice.
        </p>
      </div>
    </section>
  )
...
function ProrationRowView({ row }: { row: ProrationRow }) {
  ...
  return (
    <div className="border-b border-zinc-50 py-2 last:border-b-0">
      <div className="flex items-center gap-3">
        ...
        <div className="font-mono text-[13px] font-semibold" style={{ color: "#BE123C" }}>
