...
| [x] | High | Design | Add Job Flow updated to be like JSX. | Add Job button at top right of calendar |
...
| [x] | Medium | Design | There should be an easy way to toggle to a different month on the calendar. | Calendar |
| [x] | Low | Bug | If you click the arrow to go to a different month or week, the arrow position changes. Arrow locations should remain stable for quick navigation. | Calendar |
...
| [x] | Low | Design | Dashboard clients should be hoverable/clickable and open their client profile. | Dashboard |
| [x] | Low | Design | Dashboard clients should be sortable alphabetically. | Dashboard |
