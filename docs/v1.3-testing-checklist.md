...
| [x] | High | Flow | Vendors Page updated to be like JSX. | Vendors Page |
| [x] | High | Design | Job Detail Window updated to be like V5 JSX. | Job Detail Popup when you click on a job card |
| [x] | High | Design | Add Job Flow updated to be like JSX. | Add Job button at top right of calendar |
| [x] | High | Design | Add Client Flow updated to be like JSX. | Add Client button on Clients Page |
...
| [x] | Medium | Design | Calendar actions and Job Detail Window actions need undo functionality so mistakes can be reverted. | Calendar and Job Detail Popup |
| [x] | High | Design | Update client page to match the supplied design for real-world use cases. | Client Page |
